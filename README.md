...
if you are editing a C-family file. As completer engine compiles your file and
detects warnings or errors, they will be presented in various ways. You don't
need to save your file or press any keyboard shortcut to trigger this, it "just
...
3.  *Complete this step ONLY if you care about semantic completion support for
    ...
    **Download the latest version of `libclang`**. Clang is an open-source
    ...
    [] from [llvm.org releases][clang-download]. YCM is deisnged to work with
    [clangd][] version 7.0.0 or higher.
