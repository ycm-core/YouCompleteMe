...
- a [Jedi][]-based completion engine for Python (using the [JediHTTP][] wrapper),
...
support a variety of python versions (2.6, 2.7, 3.2, 3.3 or 3.4) as long as it
...
By default the python under which [ycmd][] runs would be used ([ycmd][] only
runs under Python 2.6 or 2.7).
...
No. The Vim client and the [ycmd][] server only support Python 2 but if you
