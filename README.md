...
version by typing `:version` inside Vim. A weekly updated 64-bit Vim for
Windows is available [here][vim64-win-download].
...
Download and install the following softwares:
 ...
 your Vim architecture.
 - [CMake][cmake-download]. Add CMake executable to the PATH environment variable.
 - [Visual Studio][visual-studio-download]. Download the community edition. During
setup, choose _Custom_ as the installation type and select the _Visual C++_
component.
 - [7-zip][7z-download]. Required to build YCM with semantic support for C-family
languages.
...
You can specify the Microsoft Visual C++ (MSVC) version using the `--msvc` option.
YCM officially supports MSVC 11 (Visual Studio 2012), 12 (2013), and 14 (2015).
...
4.  **Compile the `ycm_support_libs` libraries** that YCM needs. These libs
    ...
    following Visual Studio generator on Windows:
     - `Visual Studio 11 2012`
     - `Visual Studio 12 2013`
     - `Visual Studio 14 2015`

    Append ` Win64` to those generators if your Vim architecture is 64-bit.
