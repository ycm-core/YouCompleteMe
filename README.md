...
This command presents to the user the list of logfiles created by YCM, the [ycmd
...
option). Each logfile given as an argument is directly open (or closed if
already open) in the editor. Only for debugging purpose.
