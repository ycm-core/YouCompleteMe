...
- displaying documentation for methods, members, etc. in the [preview
  ...
  [popup next to the cursor](#the-gycm-auto-hover-option) (Vim only)
...
that it is displayed after `updatetime` milliseconds.  When set to any other
value, the hover is not automatically displayed.
