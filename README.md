...
- Install cmake, macvim and python
    ...
    apt install build-essential cmake vim python
...
One libclang-based and an [clangd]-based completer. Here is a quick comparison
of the two completer engines:

To enable [clangd][]-based completer pass `--clangd-completer`
to `install.py` while following the [installation guide](#installation).
...
For anything else, [contact us](#contact). Java support is at
...
[libclang-instructions]: https://github.com/Valloric/YouCompleteMe/wiki/C-family-Semantic-Completion-through-libclang
...
[wiki-faq]: https://github.com/Valloric/YouCompleteMe/wiki/FAQ
[wiki-full-install]: https://github.com/Valloric/YouCompleteMe/wiki/Full-Installation-Guide
