...
```viml
let g:ycm_language_server = [ { 'name': 'gopls', 'cmdline': [ 'gopls' ], 'languages': [ 'go' ] } ]
```

For more information about this option, refer to [`g:ycm_language_server` option
documentation](#the-gycm_language_server-option)
