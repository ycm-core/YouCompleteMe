...
function! Test_GetCommandResponse()
  ...
  call WaitForAssert( {->
        \  assert_equal( '',
                       \ youcompleteme#GetCommandResponse( 'NotACommand',
                                                         \ 'arg' ) ) } )
  ...
  call WaitForAssert( {->
        \  assert_equal( "Test_MultiLine()\n\nThis is the one line output.\n"
                       \ . "This is second line.",
                       \ youcompleteme#GetCommandResponse( 'ft=python',
                                                         \ 'GetDoc' ) ) } )
