...
function! Test_Manual_Visibility_Toggling()
  ...
  delfunc! HidePopupWithoutMovingCursor
  delfunc! ShowPopupWithoutMovingCursor
  delfunc! MoveCursorWithoutClosingThePopup
  delfunc! HidePopupFromANewCursorPosition
  delfunc! PopupDoesNotReappearWhenCursorMoves
  delfunc! ShowPopupFromANewCursorPosition
endfunction
