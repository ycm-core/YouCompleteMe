...
function! Test_Semantic_Completion_Popup_With_Sig_Help()
  ...
  function! Check( ... )
    ...
    call FeedAndCheckAgain( '"",', funcref( 'Check1_5' ) )
  endfunction
...
function! ClearDown_Test_Semantic_Completion_Popup_With_Sig_Help()
  set signcolumn&
...
function! ClearDown_Test_Semantic_Completion_Popup_With_Sig_Help_EmptyBuf()
  set signcolumn&
  unlet! g:ycm_add_preview_to_completeopt
