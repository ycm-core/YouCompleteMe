...
class ResolveCompletionRequest( BaseRequest ):
  ...
  def OnCompleteDone( self ):
    ...
    # completion requests, so we impleent this API by delegating to the original
    # completion request, which contains all of the code for actually handling
    # things like automatic imports etc.
