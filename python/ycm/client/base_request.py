...
class BaseRequest( object ):
  ...
  @staticmethod
  def HandleFuture( future, display = True, truncate = False ):
    ...
    on the Vim status line. Unset the |display| parameter to hide the message
  ...
  # See the HandleFuture method for the |display| and |truncate| parameters.
  @staticmethod
