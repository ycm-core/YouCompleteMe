...
def _GetCompletionInfoField( completion_data ):
  ...
  # This field may contain null characters e.g. \x00 in Python docstrings.
  # Since these characters cannot be evaluated, they are replaced with the
  # symbol used by Vim to display them.
