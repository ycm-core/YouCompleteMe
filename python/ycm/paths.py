...
def PathToPythonInterpreter():
  ...
  python_interpreter = vim.eval( 'g:ycm_ycmd_python_interpreter' )

  if python_interpreter:
    if IsPythonVersionCorrect( python_interpreter ):
      return python_interpreter

    raise RuntimeError( "Path in 'g:ycm_ycmd_python_interpreter' option "
  ...
  raise RuntimeError( "Cannot find Python 2.6+ or 3.3+. You can set its path "
                      "using the 'g:ycm_ycmd_python_interpreter' "
                      "option." )
