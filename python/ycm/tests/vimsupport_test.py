...
def AssertBuffersAreEqualsAsBytes( result_buffer, expected_buffer ):
...
def ReplaceChunk_SingleLine_Repl_1_test():
  ...
  AssertBuffersAreEqualsAsBytes( [ 'How long is a string' ], result_buffer )
  eq_( line_offset, 0 )
  eq_( char_offset, 4 )
  ...
  AssertBuffersAreEqualsAsBytes( [ 'How long is a piece of string' ],
                                 result_buffer )
  ...
  AssertBuffersAreEqualsAsBytes( [ 'How long is a piece of pie' ],
                                 result_buffer )
  eq_( new_line_offset, 0 )
...
def ReplaceChunk_SingleLine_Repl_2_test():
  ...
  AssertBuffersAreEqualsAsBytes( [ 'This is a test' ], result_buffer )
  eq_( line_offset, 0 )
  eq_( char_offset, -2 )
...
def ReplaceChunk_SingleLine_Repl_3_test():
  ...
  AssertBuffersAreEqualsAsBytes( [ 'This be a string' ], result_buffer )
  eq_( line_offset, 0 )
  eq_( char_offset, 0 )
...
def ReplaceChunk_SingleLine_Add_1_test():
  ...
  AssertBuffersAreEqualsAsBytes( [ 'This is a string' ], result_buffer )
  eq_( line_offset, 0 )
  eq_( char_offset, 5 )
...
def ReplaceChunk_SingleLine_Add_3_test():
  ...
  AssertBuffersAreEqualsAsBytes( [ 'This is not a string' ], result_buffer )
  eq_( line_offset, 0 )
  eq_( char_offset, 4 )
...
def ReplaceChunk_SingleLine_Del_1_test():
  ...
  AssertBuffersAreEqualsAsBytes( [ 'is a string' ], result_buffer )
  eq_( line_offset, 0 )
  eq_( char_offset, -5 )
...
def ReplaceChunk_SingleLine_Del_2_test():
  ...
  AssertBuffersAreEqualsAsBytes( [ 'This is a' ], result_buffer )
  eq_( line_offset, 0 )
  eq_( char_offset, -8 )
...
def ReplaceChunk_SingleLine_Unicode_ReplaceUnicodeChars_test():
  ...
  AssertBuffersAreEqualsAsBytes( [ 'This Unicode string is in the middle' ],
                                 result_buffer )
  eq_( line_offset, 0 )
  eq_( char_offset, -6 )
...
def ReplaceChunk_SingleLine_Unicode_ReplaceAfterUnicode_test():
  ...
  AssertBuffersAreEqualsAsBytes( [ 'This Uniçø∂‰ string is fåke' ],
                                 result_buffer )
  eq_( line_offset, 0 )
  eq_( char_offset, -8 )
...
def ReplaceChunk_SingleLine_Unicode_Grown_test():
  ...
  AssertBuffersAreEqualsAsBytes( [ 'å' ], result_buffer )
  eq_( line_offset, 0 )
...
def ReplaceChunk_RemoveSingleLine_test():
  ...
  expected_buffer = [ 'aAa',
                      'aCa' ]
  AssertBuffersAreEqualsAsBytes( expected_buffer, result_buffer )
  eq_( line_offset, -1 )
  eq_( char_offset, 0 )
...
def ReplaceChunk_SingleToMultipleLines_test():
  ...
  AssertBuffersAreEqualsAsBytes( [ 'aAa',
                                   'aEb',
                                   'bFBcccc',
                                   'aCa' ], result_buffer )
  eq_( line_offset, 1 )
...
def ReplaceChunk_SingleToMultipleLinesReplace_2_test():
  ...
  AssertBuffersAreEqualsAsBytes( [ 'aEb',
                                   'bFb',
                                   'bGbcccc',
                                   'aBa',
                                   'aCa' ], result_buffer )
