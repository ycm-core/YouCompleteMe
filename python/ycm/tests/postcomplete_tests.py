...
class PostComplete_test():
  ...
  def HCTCBCWMT_OldVim_MatchIsReturned_test(
    self, *args ):
    completions = [ BuildCompletion( "Test" ) ]
  ...
  @patch( 'ycm.vimsupport.VimVersionAtLeast', return_value = False )
  @patch( 'ycm.vimsupport.TextBeforeCursor', return_value = "X" )
  def HCTCBCWMT_OldVim_ShortTextDoesntRaise_test(
    self, *args ):
    completions = [ BuildCompletion( "AAA" ) ]
  ...
  @patch( 'ycm.vimsupport.VimVersionAtLeast', return_value = False )
  @patch( 'ycm.vimsupport.TextBeforeCursor', return_value = "Test" )
  def HCTCBCWMT_OldVim_ExactMatchIsntReturned_test(
    self, *args ):
    completions = [ BuildCompletion( "Test" ) ]
  ...
  @patch( 'ycm.vimsupport.VimVersionAtLeast', return_value = False )
  @patch( 'ycm.vimsupport.TextBeforeCursor', return_value = "   Quote" )
  def HCTCBCWMT_OldVim_NonMatchIsntReturned_test(
    self, *args ):
    completions = [ BuildCompletion( "A" ) ]
  ...
  @patch( 'ycm.vimsupport.TextBeforeCursor', return_value = "   Quote" )
  def HCTCBCWMT_NewVim_MatchIsReturned_test(
    self, *args ):
    completions = [ BuildCompletion( "Test" ) ]
  ...
  @patch( 'ycm.vimsupport.TextBeforeCursor', return_value = "   Quote" )
  def HCTCBCWMT_NewVim_ShortTextDoesntRaise_test(
    self, *args ):
    completions = [ BuildCompletion( "AAA" ) ]
  ...
  @patch( 'ycm.vimsupport.GetVariableValue',
          GetVariableValue_CompleteItemIs( "Test" ) )
  @patch( 'ycm.vimsupport.TextBeforeCursor', return_value = '   Quote' )
  def HCTCBCWMT_NewVim_ExactMatchIsntReturned_test(
    self, *args ):
    completions = [ BuildCompletion( "Test" ) ]
  ...
  @patch( 'ycm.vimsupport.GetVariableValue',
          GetVariableValue_CompleteItemIs( "   Quote" ) )
  @patch( 'ycm.vimsupport.TextBeforeCursor', return_value = '   Quote' )
  def HCTCBCWMT_NewVim_NonMatchIsntReturned_test(
    self, *args ):
    completions = [ BuildCompletion( "A" ) ]
  ...
  def GCUMHC_ReturnEmptyIfPendingMatches_NewVim_test(
    self ):
  ...
  def GCUMHC_ReturnEmptyIfPendingMatches_OldVim_test(
    self, *args ):
    completions = [ BuildCompletion( None ) ]
    with self._SetupForCsharpCompletionDone( completions ):
      with patch( 'ycm.vimsupport.VimVersionAtLeast', return_value = True ):
  ...
  def GCUMHC_ReturnMatchIfExactMatchesEvenIfPartial_NewVim_test(
    self, *args ):
    info = [ "NS", "Test", "Abbr", "Menu", "Info", "Kind" ]
    completions = [ BuildCompletion( *info ),
  ...
  def GCUMHC_DontReturnMatchIfNontExactMatchesAndPartial_NewVim_test(
    self ):
    info = [ "NS", "Test", "Abbr", "Menu", "Info", "Kind" ]
