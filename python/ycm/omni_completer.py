...
class OmniCompleter( Completer ):
  ...
  def ComputeCandidatesInner( self, request_data ):
    ...
    try:
      ...
      # Contrarily to what the documentation says, Vim only stops completion if
      # the value returned by the omnifunc is -3 or -2. In other cases, if the
      # value is negative or greater than the current column, the start column
      # is set to the current column; otherwise, the value is used as the start
      # column.
