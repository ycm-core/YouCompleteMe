  ...
  def UpdateMatches( self ):
    ...
    for diags in self._line_to_diags.values():
      ...
      for diag in reversed( diags ):
        for line, column, name, extra_args in _ConvertDiagnosticToTextProperties( diag ):
          ...
          diag_prop = vimsupport.DiagnosticProperty(
              ...
              line,
              column,
              extra_args[ 'end_col' ] - column if 'end_col' in extra_args else column )
          try:
